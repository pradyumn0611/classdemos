...
public class PizzaMania {
	...
	{
		if (name.equalsIgnoreCase("Delux Veggie")||name.equalsIgnoreCase
				("Veg Extravaganza")||name.equalsIgnoreCase("Idli Tandoori Paneer")||name.equalsIgnoreCase("Farmhouse")
	...
	private static void pizzaPriceBill(String pizzaName,String pizzaSize,String pizzaCrust,double toppingPrice)
	{//local variable for getting price of different pizza and size
	...
	public static void main(String[] args) {
		...
		System.out.println("------------------------------------------------");
		System.out.println("Pizzas Catalogue : |Delux Veggie||Veg Extravaganza||Idli Tandoori Paneer||Farmhouse||Peppy Paneer||Mexican Green Wave|\n");
		...
		if(pizzaSize.equals("S")||pizzaSize.equals("M")||pizzaSize.equals("L"))
		{
			...
			System.out.println("Crusts available:|new hand tosted||cheese brust||fresh pain pizza||classic hand tosted||wheat thin crust");
			//inputs crust
